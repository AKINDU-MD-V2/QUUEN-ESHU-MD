...
cmd({
  ...
  try {
    ...
    let _0x17702e = "\n*✾☁QUEEN-ISHU-TIKTOK☁✾*\n            *    ͬ      ͬ \\x0a*TITLE*:  " + _0x3cc321.result.title + "\n\n*🔢 REPLY BELOW THE NUMBER*\n\n*VIDEO FILE* 🎬\n\n*1*       *♛SD QUALITY♛*\n*2*       *♛HD QUALITY♛*\n\n*♛AUDIO FILE♛*🎧\n\n*3*       *♛AUDIO♛*\n\n> QUEEN-ISHU ✻\n     ";
...
cmd({
  ...
  try {
    ...
    const _0x3ec2b8 = "\n*🎥QUEEN-ISHU-FACEBOOK🎥\n┃          \n\n*⌛DUARATIONS* : " + _0x21f387.result.duration + "\n\n*🔢 NUMBER*\n\n*VIDEO DOWNLOADER 🎬*\n\n*1.1*       *♛SD QUALITY♛*\n*1.2*       *♛HD QUALITY♛*\n\n*AUDIO 🎧*\n\n*2.1*       *AUDIO*\n*2.2*       *DOCUMENT*\n*2.3*       *VOICE*\n\n> QUEEN-ISHU ✻\n";
            ...
            if (_0x48db83 === "2.1") {
              ...
              if (_0x48db83 === '2.2') {
                await _0x1ac136.sendMessage(_0x231677, {
                  ...
                  'mimetype': "audio/mpeg",
                  'fileName': "QUEEN-ISHU-MD/FBDL.mp3",
                  'caption': "**© CREATED BY LAKSIDU NIMSARA · · ·**"
                }, {
                  'quoted': _0x5ded0a
                });
...
cmd({
  ...
  try {
    ...
    _0x5e68b2("An error : " + _0x41ba96.message);
  }
});
cmd({
  'pattern': 'ig',
  ...
  try {
    if (!_0x133e89) {
      return _0x2d5654.reply("PLEASE GIVE ME a LINK...");
    }
    _0x2d5654.react('⬇️');
      ...
      if (_0x49bbc0) {
        ...
        if (!isNaN(_0x34c5d6) && _0x34c5d6 > 0x0 && _0x34c5d6 <= _0x4d43f1.length) {
          ...
          if (_0x16231a) {
            ...
            await _0x4ee609("*not found for selected*");
          }
        } else {
          await _0x4ee609("*☁INVAIDE SELECTIONS. PLEASE CHOOSE a VAIDE NUMBERE☁.*");
        }
      }
    });
  } catch (_0x59ac25) {
...
cmd({
  ...
  try {
    if (!_0x4564d6) {
      return await _0xc4807("*☁PLEASE PROVIDE A SEARCH☁ (e.g., HARRYPOTER)*");
    }
      ...
      if (_0x14e10e) {
        ...
        if (!isNaN(_0x284411) && _0x284411 > 0x0 && _0x284411 <= _0x572788.length) {
          ...
          if (_0x32f8e7) {
            ...
            try {
              ...
              if (_0x46edb0) {
                await _0x5049fe.sendMessage(_0x4a17a3, {
                  ...
                  'mimetype': "video/mp4",
                  'fileName': "AP sinhalasub | " + _0x1d0aed.title + '.mp4',
                  'caption': _0x1d0aed.title + " |  *LAKSIDU NIMSARA*\n\n> QUEEN-ISHU-MD"
                }, {
                  'quoted': _0x171143
                });
              } else {
            ...
            await _0xc4807("NO DOWNLOAD LINK FOR THIS.");
          }
        } else {
          await _0xc4807("☁PLEASE REPLY NUMBER.");
        }
      }
    });
  } catch (_0x546741) {
...
cmd({
  ...
  try {
    ...
    let _0x408ceb = "\n*✾☁QUEEN-ISHU-MD-APK☁✾*\n            *ᴸ  ͬ  ͣ*\n\n*🏷️ NAME :* " + _0x35ebe9.datalist.list[0x0].name + "\n\n*📦 SIZE :* " + _0x5a853a + "MB\n\n*🔖 PACKEGE :* " + _0x35ebe9.datalist.list[0x0]['package'] + "\n\n*📆 LAST UPDATE :* " + _0x35ebe9.datalist.list[0x0].updated + "\n\n*👤 CREATER :* " + _0x35ebe9.datalist.list[0x0].developer.name + "\n\n> QUEEN-ISHU-MD ✻\n";
    await _0x3cbff5.react('⬆');
...
cmd({
  ...
  'react': '👀',
  'category': "download",
  'desc': "Search movies on LAKSIDU and get download links",
  'filename': __filename
  ...
  try {
    if (!_0x2f9e41) {
      return await _0x20f27b("*PLEASE PROVIDE a SEARCH! (e.g., BIGIL)*");
    }
    ...
    let _0x563ad3 = "👀 *Search Results for* \"" + _0x2f9e41 + "\":\n\n";
      ...
      if (_0xfacf40) {
        ...
        if (!isNaN(_0x5975fb) && _0x5975fb > 0x0 && _0x5975fb <= _0x66d8c6.length) {
          ...
          try {
                  ...
                  await _0x3dfd8e.sendMessage(_0x4a183a, {
                    ...
                    'contextInfo': {
                      ...
                      'externalAdReply': {
                        ...
                        'body': "☁DOWNLOAD POWERD BY QUEEN-ISHU-MD☁",
                        'mediaType': 0x1,
            ...
            console.error("ERROR SERCH MOVIE:", _0x3bf620);
...
cmd({
  ...
  try {
    ...
    if (!_0x1ff06b) {
      return _0x5e2655.reply("PLEASE GIVE ME a LINK...");
    }
